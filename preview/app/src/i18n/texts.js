...
export const TEXTS = {
  es: {
    ...
    trainingSlotEmpty: "?",
    trainingInstrDealing: "Elige tus cartas\nvocal o consonante",
    trainingInstrStrategy: "Decide tu carta de acción",
    ...
    trainingShieldPromptBody: "{source} usa {action}. ¿Bloquear con ESCUDO TOTAL?",
    ...
    trainingExitConfirmTitle: "Finalizar entrenamiento",
  ...
  en: {
    ...
    trainingSlotEmpty: "?",
    trainingInstrDealing: "Pick your cards\nvowel or consonant",
    trainingInstrStrategy: "Pick your action card",
    ...
    trainingShieldPromptBody: "{source} uses {action}. Block with TOTAL SHIELD?",
