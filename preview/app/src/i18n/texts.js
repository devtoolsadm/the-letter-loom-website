...
export const TEXTS = {
  es: {
    ...
    matchScoreboardOpen: "Ver marcador",
    matchScoreboardPlayerHeader: "Jugador",
    matchScoreboardRoundShort: "B{round}",
    matchScoreboardReadOnly: "Solo lectura",
    matchScoreboardOdd: "Puntuaci¢n impar en {player}",
    ...
    matchRulesConfigTitle: "Configurar reglas de palabras válidas",
    matchRulesInfo: "Puedes cambiar las reglas para jugar como más os guste",
  ...
  en: {
    ...
    matchScoreboardOpen: "View scoreboard",
    matchScoreboardPlayerHeader: "Player",
    matchScoreboardRoundShort: "R{round}",
    matchScoreboardReadOnly: "Read-only",
    matchScoreboardOdd: "Odd score in {player}",
    ...
    matchRulesConfigTitle: "Configure valid word rules",
