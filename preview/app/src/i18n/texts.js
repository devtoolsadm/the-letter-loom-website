...
export const TEXTS = {
  es: {
    ...
    installRequiredTitle: "Esta app solo funciona instalada",
    installRequiredDescription: "Si aún no la tienes en tu dispositivo, instálala ahora. Si ya está instalada, ábrela desde su icono.",
  ...
  en: {
    ...
    installRequiredTitle: "This app only works once installed",
    installRequiredDescription: "If you don't have it on your device yet, install it now. If it's already installed, open it from its icon.",
