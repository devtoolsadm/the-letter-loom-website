export const TEXTS = {
  es: {
    ...
    installPromptDescription: "Instala el juego para acceder más rápidamente y poder jugar a pantalla completa y sin conexión o consumir datos de internet.",
  ...
  en: {
    ...
    installPromptDescription: "Add the game to your home screen for faster access and to play in full-screen mode and offline or without using mobile data.",
