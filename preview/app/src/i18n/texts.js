...
export const TEXTS = {
  es: {
    ...
    installPromptDescription:
      "Instala el juego para acceder mas rápido y jugar a pantalla completa incluso sin conexión.",
    ...
    pilotConfigTitle: "Configuración",
    pilotStrategyLabel: "Fase estrategia",
    pilotCreationLabel: "Fase creación",
    pilotStartMatch: "Iniciar partida",
    pilotRound: "Ronda {round}",
    pilotStartStrategy: "▶ Iniciar",
    pilotStartCreation: "▶ Iniciar",
    pilotStartCreationCTA: "▶ Siguiente fase",
    pilotTimeUp: "Tiempo!",
