...
export const TEXTS = {
  es: {
    ...
    matchWinnerByRounds: "El ganador sera el jugador con mas puntos al finalizar {rounds} bazas",
    ...
    matchConfigCustomize: "Personalizar...",
  ...
  en: {
    ...
    matchConfigCustomize: "Customize...",
