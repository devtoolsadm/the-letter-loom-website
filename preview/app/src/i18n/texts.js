...
export const TEXTS = {
  es: {
    ...
    authSubtitleFresh: "Entra o crea tu cuenta con tu correo",
    ...
    authLegalText: "Al continuar aceptas nuestra {privacy} y {legal}.",
  ...
  en: {
    ...
    authSubtitleFresh: "Sign in or create your account with your email",
    ...
    authLegalText: "By continuing you accept our {privacy} and {legal}.",
